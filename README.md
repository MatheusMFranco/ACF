# ALREADYHAS: Cosmic and Fantastic
...
To generate the necessary tables of the application, create the "acf" database in MySQL and run the following class:
*br.com.alreadyhas.cf.util.ConfigurationUtil.CreateEntityManager*
